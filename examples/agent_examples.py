"""
🤖 Agent Examples - Z.AI SDK

⚠️  NOTA: Este arquivo foi dividido em arquivos separados para facilitar o uso.

Veja:
- translation_agent_example.py - Exemplos de tradução
- video_effects_agent_example.py - Exemplos de geração de vídeo

Este arquivo é mantido para compatibilidade, mas os novos arquivos
são mais organizados e fáceis de usar.
"""
